    ...
    <div className="p-6 space-y-6">
      ...
      <div className="space-y-2">
        <Label htmlFor="location">
          {t("profile.location")} <span className="text-destructive">*</span>
        </Label>
        <Input
          id="location"
          name="location"
      ...
      <div className="flex justify-end pt-4">
        <Button onClick={handleNext}>{t("form.continue")}</Button>
      </div>
    </div>
  );
};
